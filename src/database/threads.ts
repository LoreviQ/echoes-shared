 ...
 * @returns A promise that resolves to the thread and an error
 */
export async function getThread(threadId: string, supabase: SupabaseClient): Promise<{ thread: ThreadSchema, error: PostgrestError | null }> {
